...
curl -O https://generalstore123.blob.core.windows.net/pytorchwheels/torch-1.0.0a0+8619230-cp35-cp35m-linux_x86_64.whl
...
# wget 
# /anaconda/envs/pytorch031/bin/python -m pip install torchvision 
